...
| `legacy-data-import@1` (Diorka)          | none                         | export/migration from cane.gestortectic.com (TecTic "Gestor", login-gated) + Excel workbooks (Comparatiu, catalogues) | BRD §7.3; credentials stay out of the repo                  |
